public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: tries to dequeue index 1 but it should be index 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue is inserting at the first position.
    ...
    {
        _queue.Add(value); // Needs to add value at the end of the queue
    }
    ...
    private int Dequeue()
    {
        ...
        var value = _queue[0]; //List start at 0
        _queue.RemoveAt(0);
        return value;
    }
}