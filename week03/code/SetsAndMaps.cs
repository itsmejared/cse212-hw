...
public static class SetsAndMaps
{
    ...
    public static string[] FindPairs(string[] words)
    {
        ...
        {
            // Ignore words where both characters are identical (e.g., "aa")
            if (word[0] == word[1])
            {
                continue;
            }
            ...
            // Check if the reversed word has already been observed
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        for (int i = 0; i < word1.Length; i++)
        {
            ...
            letterCounts[lowerChar] = letterCounts.GetValueOrDefault(lowerChar) + 1;
        }

        // Pass 2: decrement counts
        for (int i = 0; i < word2.Length; i++)
        {
            ...
            if (!letterCounts.TryGetValue(lowerChar, out int count) || count == 0)
            {
                return false;
            }
            ...
            if (count == 1)
            {
                letterCounts.Remove(lowerChar);
            }
            else
            {
                letterCounts[lowerChar] = count - 1;
            }
        }
